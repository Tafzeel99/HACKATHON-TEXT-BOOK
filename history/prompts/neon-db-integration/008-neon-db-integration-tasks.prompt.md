---
id: "008-neon-db-integration-tasks"
stage: "tasks"
title: "neon-db-integration-tasks"
date: "2025-12-23"
...
- [ ] T001 Create app/db directory structure in backend/app/db/
- [ ] T002 Install asyncpg dependency for Neon Postgres connection
- [ ] T003 Update requirements.txt with asyncpg and neon dependencies
- [ ] T004 Create initial neon_client.py file in backend/app/db/
- [ ] T005 Add Neon DB configuration to backend/app/config.py
- [ ] T006 Update .env.example with NEON_DB_URL variable

## Phase 2: Foundational Components

**Goal**: Implement core Neon DB infrastructure components

- [ ] T010 Create NeonResult Pydantic model in backend/app/db/schemas.py
- [ ] T015 Implement NeonClient class with connection pooling in backend/app/db/neon_client.py
- [ ] T020 Create Neon database schema migration files
- [ ] T025 Implement query_neon_structured_knowledge function in backend/app/db/neon_client.py
- [ ] T030 Add connection health check endpoint to backend/app/api.py
...
- [ ] T035 [P] [US1] Create BookModules table model in backend/app/db/models.py
- [ ] T040 [P] [US1] Create BookChapters table model in backend/app/db/models.py
- [ ] T045 [P] [US1] Create Definitions table model in backend/app/db/models.py
- [ ] T050 [P] [US1] Create Glossary table model in backend/app/db/models.py
- [ ] T055 [US1] Create TocIndex table model in backend/app/db/models.py
- [ ] T060 [US1] Implement keyword search function for all Neon entities
- [ ] T065 [US1] Update HybridRouter to call Neon when appropriate
...
- [ ] T075 [P] [US2] Update QueryResponse schema to include context_source field in backend/app/schemas.py
- [ ] T080 [P] [US2] Update QueryResponse schema to include confidence field in backend/app/schemas.py
- [ ] T085 [US2] Implement priority routing logic in backend/app/router.py (user → neon → qdrant → general)
- [ ] T090 [US2] Implement confidence threshold logic for Neon results
- [ ] T095 [US2] Implement combined context handling in agent response generation
- [ ] T100 [US2] Add debug context information when debug_context=true
...
- [ ] T110 [US3] Update QueryRequest schema to properly handle selected_text in backend/app/schemas.py
- [ ] T115 [US3] Implement user-selected text priority in backend/app/router.py
...
- [ ] T130 Add comprehensive error handling for Neon DB connection failures
- [ ] T135 Update OpenAPI documentation with new response fields
...
- [ ] T155 Document environment variables for Neon DB configuration
