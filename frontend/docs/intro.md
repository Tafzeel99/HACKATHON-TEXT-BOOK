...
<img src={useBaseUrl('/img/Robotics and Artificial Intelligence (AI).jpg')} alt="Robotics and AI Banner" style={{width: '70%', borderRadius: '8px', marginBottom: '2rem', display: 'block', marginLeft: 'auto', marginRight: 'auto'}} />
